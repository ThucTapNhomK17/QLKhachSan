    ...
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            using (htEntities context = new htEntities())
            {
                ...
                quyen = Convert.ToByte(context.getPermission(LoginForm.username, LoginForm.password).FirstOrDefault());
                if (quyen == 0)
                {
                    btnNhanVien.Visible = btnNguoiDung.Visible = btnPhong.Visible = btnLoaiPhong.Visible = bntDichVu.Visible = btnLoaiDV.Visible = false;
                    panelQuanLy.Size = new System.Drawing.Size(183, 40);
                }
            }
        }
    }
