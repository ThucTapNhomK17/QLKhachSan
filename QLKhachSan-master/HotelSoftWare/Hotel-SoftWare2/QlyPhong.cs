...
namespace Hotel_SoftWare2
{
    public partial class QlyPhong : Form
    {
        ...
        private void RoomID()
        {
            ...
            {
                textBoxMaPhong.Text = "MP00";
                chuoi = textBoxMaPhong.Text;
            }
            chuoi2 = Convert.ToInt32(chuoi.Remove(0, 2));
            if (chuoi2 + 1 < 10)
            {
        ...
        private void TypeRoomCombobox()
        {
            var getIdMLPList = from LoaiPhong in room.LoaiPhongs
                               select LoaiPhong;
            comboBoxMaLoai.DataSource = getIdMLPList.ToList();
