...
namespace Hotel_SoftWare2
{
    public partial class UsersForm : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                user.updateAcc(textBoxMaNV.Text, textBoxTenTK.Text, enc.MaHoa(textBoxMK.Text), checkBoxLeTan.Checked = checkBoxQuanLy.Checked);
                try
                {
        ...
        {
            dgvUsers.DataSource = user.TKND(textBoxTimKiem.Text);
            if (textBoxTimKiem.Text == "")
            {
                dgvUsers.DataSource = user.getAcc1();
            }
            clearText();
